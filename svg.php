...
<script>
    var lista = document.getElementById("list5");
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <h1 class="mt-5">SVG to CSS</h1>



        <label for="input">Enter your SVG here (demos:
            <button id="circle" onclick="circle();" class="btn btn-outline-secondary">1</button>
            <button id="use" onclick="use();" class="btn btn-outline-secondary">2</button>
            <button id="animate" onclick="animate2();" class="btn btn-outline-secondary" title="only works in some browsers e.g. chrome">3</button>
            <button id="trans" onclick="trans();" class="btn btn-outline-secondary">4</button>
            <button id="fenders" onclick="fenders();" class="btn btn-outline-secondary">5</button>
            )
        </label>
...
<!-- <p class="lead">Pin a footer to the bottom of the viewport in desktop browsers with this custom HTML and CSS. A fixed navbar has been added with <code>padding-top: 60px;</code> on the <code>main &gt; .container</code>.</p>
                ...
                <button type="button" onclick="replace1();" class="btn btn-secondary">Convert to CSS</button>
            ...
            <div class="col-4">
                ...
                <textarea disabled id="image" placeholder="convert to preview image" class="form-control" style="height:350px;"></textarea>
    ...
    <div class="container">
        ...
        <h5>Paste or drag the content of a valid SVG document source above and generate the data URI that should work across multiple browsers, check out the example below:</h5>
        <br><br>

        <h3>Exemple</h3>

        <h6>SVG: <code>&lt;svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"&gt;
  &lt;circle cx="20" cy="20" r="20" fill="none" stroke="#aaa" stroke-width="2" /&gt;
&lt;/svg&gt;</code></h6>
        <br>
        <h6>CSS: <code>background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 40 40' width='40' height='40'%3e%3ccircle cx='20' cy='20' r='20' fill='none' stroke='%23aaa' stroke-width='2' /%3e%3c/svg%3e");</code></h6>
    </div>
...
<script>
            ...
            encoded = replaceAll(encoded, "%", "%25");
                    ...
                    document.getElementById("texto").value = style;
                    //    document.body.style.backgroundImage = uri;

                    document.getElementById("image").placeholder = "";
            document.getElementById("image").style.backgroundImage = uri;
    ...
    function clear1() {
         ...
         document.getElementById("image").placeholder = "convert to preview image";
